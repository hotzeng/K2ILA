auto instr = model.NewInstr("xorb_r8_r8");
UPDATE_R(R2, Concat(R2(63, 8), (R2(7, 0)) ^ (R1(7, 0))));
...
instr.SetUpdate(ZF, Ite( ((R2(7, 0)) ^ (R1(7, 0))) == (BvConst(0, 8)), bv(1), bv(0)));
instr.SetUpdate(SF, (R2(7, 7)) ^ (R1(7, 7)));
instr.SetUpdate(OF, bv(0));
instr.SetUpdate(rip, nxt_rip);
RECORD_INST("xorb_r8_r8");
