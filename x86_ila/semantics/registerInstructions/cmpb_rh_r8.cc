auto instr = model.NewInstr("cmpb_rh_r8");
...
instr.SetUpdate(AF, ((R1(4, 4)) ^ (R2(12, 12))) ^ (add(59, 59)));
instr.SetUpdate(ZF, Ite( (add(62, 55)) == (BvConst(0, 8)), bv(1), bv(0)));
instr.SetUpdate(SF, add(62, 62));
instr.SetUpdate(OF, Ite( ((~ (R1(7, 7))) == (BvConst(1, 1))) == ((R2(15, 15)) == ((bv(1)) == ((add(62, 62)) == (BvConst(1, 1))))), bv(1), bv(0)));
instr.SetUpdate(rip, nxt_rip);
RECORD_INST("cmpb_rh_r8");
